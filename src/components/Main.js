...
class ControllerUnit extends React.Component {
    ...
    render(){
        let contrllerUnitClassName = 'controller-unit';
        if(this.props.arrange.isCenter){
            contrllerUnitClassName += ' is-center';
            if(this.props.arrange.isInverse){
                contrllerUnitClassName += ' is-inverse';
            }
        }
        return (
            <span className={contrllerUnitClassName} onClick={this.handleClick}></span>
        );
    }
}
